...
export default function LoginPage() {
  ...
  const [state, action] = useActionState(signIn, { message: null });
        ...
        <div className="w-full max-w-md bg-white rounded-xl shadow-2xl overflow-hidden">
          ...
          <div className="bg-gray-50 px-6 py-4 text-center border-t border-gray-200">
            <p className="text-gray-600 text-sm">
              ...
              <Link href="/auth/register" className="font-medium text-teal-600 hover:underline">
                Register here
              </Link>
            </p>
          </div>
...
function LoginButton() {
  ...
  return (
    <button
      type="submit"
      className="w-full bg-teal-600 hover:bg-teal-700 text-white py-3 px-4 rounded-lg font-medium transition-colors disabled:opacity-70 disabled:cursor-not-allowed flex items-center justify-center"
      disabled={pending}
    >
      {pending ? (
        <>
