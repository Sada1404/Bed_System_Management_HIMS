...
import { PatientAdmissionForm } from './PatientsForm'
import { PatientAdmissionList } from './PatientsList'
  ...
  const renderTabContent = () => {
    switch (activeTab) {
      case "add-service":
        return (
          <ServiceForm
            handleSubmit={(e, data) => handleSubmit(e, data, "service")}
            isEditing={!!editingId}
            isLoading={isLoading}
          />
        )
      ...
      case "add-package":
        return (
          <PackageForm
            services={services}
            handleSubmit={(e, data) => handleSubmit(e, data, "package")}
            isEditing={!!editingId}
            isLoading={isLoading}
          />
        )
      case "package-list":
        return (
          <PackageList
            packages={packages}
            onEdit={(id) => handleEdit(id, "package")}
